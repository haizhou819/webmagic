...
public class CsdnBlogPageProcessor implements PageProcessor{
    ...
    public void process(Page page) {
        ...
        if (!page.getUrl().regex("http://blog\\.csdn\\.net/" + username + "/article/details/\\d+").match()) {
        	...
        	urlList = page.getHtml().xpath("//div[@id='article_list']").links()// 限定文章列表获取区域
        	...
        	list = page.getHtml().xpath("//div[@id='papelist']").links()// 限定其他列表页获取区域
            ...
            // 设置标题//*[@id="article_details"]/div[1]/h1/span/a   //div[@class='article_title']//span[@class='link_title']/a
            csdnBlog.setTitle(
                    page.getHtml().xpath("//*[@id=\"article_details\"]/div[1]/h1/span/a/text()").get());
            // 设置日期
            csdnBlog.setDate(
    ...
    public static void main(String[] args) {
        ...
        Spider spider = Spider.create(new CsdnBlogPageProcessor());
        spider.addUrl("http://blog.csdn.net/" + username).thread(1).run();
